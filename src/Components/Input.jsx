...
<div className="flex justify-center items-center ">
  {/* Form for User Input */}
  <form className="form w-full max-w-md px-4">
    ...
    {/* Submit Button */}
    <button type="submit" className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700 w-full">Generate Plan</button>
  </form>
</div>
